...
(function () {
    ...
    (function () {
        var a = [], d = CKEDITOR.env.gecko ? "-moz-" : CKEDITOR.env.webkit ? "-webkit-" : CKEDITOR.env.ie ? "-ms-" : "",
            b = /&/g, c = />/g, e = /</g, g = /"/g, k = /&(lt|gt|amp|quot|nbsp|shy|#\d{1,5});/g,
            h = {lt: "\x3c", gt: "\x3e", amp: "\x26", quot: '"', nbsp: " ", shy: "­"}, p = function (a, f) {
        ...
        CKEDITOR.tools = {
            ...
            transformPlainTextToHtml: function (a, f) {
                ...
                if (!b) {
                    var d = /\n{2}/g;
                    if (d.test(c))var m = "\x3c" + h + "\x3e", p = "\x3c/" + h + "\x3e",
            ...
            is: function () {
                ...
                if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ?
                    ...
                    var e = this.$.getBoundingClientRect(), g = f.$.documentElement,
                        m = g.clientTop || d.$.clientTop || 0, x = g.clientLeft || d.$.clientLeft || 0, k = !0;
                ...
                if (b) {
                    do if ((b.$.clientWidth && b.$.clientWidth < b.$.scrollWidth || b.$.clientHeight && b.$.clientHeight < b.$.scrollHeight) && !b.is("body"), b.is("html")) {
                        var c = b.getWindow();
                        try {
    ...
    (function () {
        function a(a, b) {
            ...
            f = c.endContainer;
            var e = c.startOffset, B = c.endOffset, g, l = this.guard, q = this.type,
            ...
            clone: function () {
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        var p, Q,
                            P = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {br: 1} : null),
                            v = null, G = function (a) {
                ...
                if (!this.collapsed) {
                    ...
                    var d = this.clone(), e = this.startContainer, m = this.endContainer, g = this.startOffset,
                        h = this.endOffset, k = 1, r = 1;
                ...
                var c = new CKEDITOR.dom.elementPath(this.startContainer, this.root),
                    d = new CKEDITOR.dom.elementPath(this.endContainer, this.root), e = c.block, m = d.block, g = null;
    ...
    (function () {
        ...
        CKEDITOR.filter.prototype = {
            allow: function (b, c, d) {
                ...
                var e = this, q = [], n = this.editor && this.editor.config.protectedSource, t, f = !1,
        ...
        var Q = {styles: 1, attributes: 1, classes: 1},
            ...
            G = {styles: /{([^}]+)}/, attrs: /\[([^\]]+)\]/, classes: /\(([^\)]+)\)/}, E = /^cke:(object|embed|param)$/,
        ...
        CKEDITOR.htmlParser.fragment.fromHtml =
            function (g, k, h) {
                ...
                var y = new CKEDITOR.htmlParser,
                    ...
                    x = [], J = [], w = m, F = "textarea" == m.name, l = "pre" == m.name;
                    ...
                    if (a(n)) x.push(n); else {
                        ...
                        if ("br" == e) J.push(n); else {
                            for (; !(g = (f = w.name) ? CKEDITOR.dtd[f] || (w._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, n.isUnknown || w.isUnknown || g[e]);)if (w.isOptionalClose) y.onTagClose(f); else if (e in b && f in b) f = w.children, (f = f[f.length - 1]) && "li" == f.name || B(f = new CKEDITOR.htmlParser.element("li"), w), !n.returnPoint && (n.returnPoint = w), w = f; else if (e in CKEDITOR.dtd.$listItem &&
                                !z(e, f)) y.onTagOpen("li" == e ? "ul" : "dl", {}, 0, 1); else if (f in d && !z(e, f)) !n.returnPoint && (n.returnPoint = w), w = w.parent; else if (f in CKEDITOR.dtd.$inline && x.unshift(w), w.parent) B(w, w.parent, 1); else {
                                n.isOrphan = 1;
                                break
                            }
                            p(e);
        ...
        a.prototype = {
            add: function (a, c, d) {
                ...
                var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment,
                    g = Array.prototype.slice.call(arguments, 1), k = this.rules, h = k.length, p, r, f, B;
    ...
    (function () {
        ...
        CKEDITOR.htmlDataProcessor = function (b) {
            ...
            b.on("toHtml", function (a) {
                a = a.data;
                var c = a.dataValue, l, c = m(c, b), c = f(c, R), c = r(c), c = f(c, H), c = c.replace(P, "$1cke:$2"),
        ...
        var x = /(?:&nbsp;|\xa0)$/, J = "{cke_protected}", w = CKEDITOR.dtd,
            F = "caption colgroup col thead tfoot tbody".split(" "), l = CKEDITOR.tools.extend({}, w.$blockLimit,
            w.$block), q = {elements: {input: h, textarea: h}},
        ...
        var C = /<(a|area|img|input|source)\b([^>]*)>/gi,
            D = /([\w-:]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, M = /^(href|src|name)$/i,
            H = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi,
            R = /(<textarea(?=[ >])[^>]*>)([\s\S]*?)(?:<\/textarea>)/gi, Q = /<cke:encoded>([^<]*)<\/cke:encoded>/gi,
            P = /(<\/?)((?:object|embed|param|html|body|head|title)[^>]*>)/gi,
            v = /(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi, G = /<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi
    })();
    "use strict";
            ...
            return function (m, v, G, E) {
                ...
                if (!E.checkReadOnly()) {
                    ...
                    if (H) {
                        ...
                        var F, J;
                        v = w.startContainer;
                        var K = m.endPath.elements[0], Y, L = K.getPosition(v),
                ...
                list: {
                    detectMerge: function (a, b) {
                        var d = c(b, a.bookmark), e = d.startPath(), f = d.endPath(),
                            l = e.contains(CKEDITOR.dtd.$list), g = f.contains(CKEDITOR.dtd.$list);
                        ...
                        if (a.mergeListBookmark) {
                            var d = a.mergeListBookmark.startNode, e = a.mergeListBookmark.endNode,
                                f = new CKEDITOR.dom.elementPath(d, c), l = new CKEDITOR.dom.elementPath(e, c);
                            if (a.mergeList) {
                    ...
                    function a(c) {
                        var e =
                                [], f, l = new CKEDITOR.dom.walker(c), g = c.startPath().contains(d),
                            n = c.endPath().contains(d), k = {};
    ...
    (function () {
        ...
        var B = "function" != typeof window.getSelection, u = 1, z = CKEDITOR.tools.repeat("​", 7),
            y = new RegExp(z + "( )?", "g"), m, x, J = CKEDITOR.dom.walker.invisible(1), w = function () {
                function a(b) {
                    return function (a) {
        ...
        CKEDITOR.on("instanceCreated", function (b) {
            ...
            e.on("contentDom", function () {
                ...
                var f = e.document, l = CKEDITOR.document, g = e.editable(), h = f.getBody(),
                    q = f.getDocumentElement(), m = g.isInline(), p, v;
            ...
            getNative: function () {
                ...
                if (a.length)if (this.isLocked) {
                    ...
                    a:{
                        var m, p;
                        if (1 == a.length &&
                            !(p = a[0]).collapsed && (h = p.getEnclosedNode()) && h.type == CKEDITOR.NODE_ELEMENT && (p = p.clone(), p.shrink(CKEDITOR.SHRINK_ELEMENT, !0), (m = p.getEnclosedNode()) && m.type == CKEDITOR.NODE_ELEMENT && (h = m), "false" == h.getAttribute("contenteditable")))break a;
                        h = void 0
                    }
    ...
    (function () {
        ...
        function F(b) {
            ...
            b.on("contentDom", function () {
                ...
                var d = b.editable(), h = CKEDITOR.plugins.clipboard.getDropTarget(b), n = b.ui.space("top"),
                    w = b.ui.space("bottom");
        ...
        CKEDITOR.plugins.add("clipboard", {
            requires: "dialog", init: function (b) {
                ...
                b.on("paste", function (a) {
                    a = a.data;
                    var d = a.type, e = a.dataValue, f, p = b.config.clipboard_defaultContentType || "html",
